...
var sendText = function(userPhoneNumber, event, timeoutTime) {
  ...
  client.sendMessage({
      ...
      from: '+14156894189', // A number you bought from Twilio
      body: 'Hurry Up! Leave now to get to ' + event.eventName + ' by ' + eventTime // body of the SMS message, standard text message limit: 160 characters
